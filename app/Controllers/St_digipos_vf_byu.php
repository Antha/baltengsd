...
use App\Models\StDigiposVfByuModel;
helper(['custom_helper']);

class St_digipos_vf_byu extends BaseController
{
    protected $model;

    public function __construct()
    {
        $this->model = new StDigiposVfByuModel();
    }
    ...
    public function index()
    {
        ...
        //$parse_validity = "ALL";//hapus & ganti dengan data validity dari input user
        ...
        //$parse_hari_pjp = "ALL";//hapus & ganti dengan data hari pjp dari input user
        ...
        return view('st_digipos_vf_byu_page',$data);
    }
    ...
    public function summary_all()
    {
        ...
        return view('st_digipos_vf_byu_page_v2',$data);
    ...
    public function summary_by_outlet()
    {
        ...
        return view('st_digipos_vf_byu_page_v3',$data);
