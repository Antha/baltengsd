...
class St_digipos_vf_sim_dashboard extends BaseController
{
    protected $model;
    ...
    public function index()
    {
        ...
        if($user_type == "user"){
             return redirect()->to('/st_digipos_vf_sim');
        }

        $data['tap_list'] = query_tap_list(); 

        $monitoring_list = ['ALL','1D','2D','3D','5D','7D','14D','28D','30D'];
        ...
        return view('st_digipos_vf_sim_dashboard_page',$data);
