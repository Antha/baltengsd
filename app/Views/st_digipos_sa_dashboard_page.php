                    ...
                    <div class="container-fluid rounded main-bg pt-3">
                        <div class="row mt-1">
                            ...
                            <div class="filter_group_top">
                                <form id="filterFormOmsetTrxTop" method="post" action="<?php echo esc(base_url('/st_digipos_sa_dashboard')); ?>" enctype="multipart/form-data">
                                    <?= csrf_field() ?>
                            ...
                            <div id="table_st_digipos_summary" class="col-12 mb-3">
                            ...
                            <div id="table_st_digipos_detail" class="col-12 mb-3">
                                <div class="table-responsive">
...
<script>
     $(document).ready(function() {
        $('#filter_tap').on('change', function () {
            ...
            $.ajax({
                url: "<?= base_url('/st_digipos_sa_dashboard/getPicByTap') ?>",
                type: "POST",
                data: {
                    tap: tap,
        ...
        $('#exportCsvTop').click(function () {
            ...
            const filename = `st_digipos_sa_summary_${dateformat}.xlsx`;
        ...
        $('#exportCsvBot').click(function () {
            ...
            // nama file
            const dateformat = new Date().toISOString().replace(/[-:.TZ]/g, '').slice(0,14);
            const filename = `st_digipos_sa_detail_${dateformat}.xlsx`;
        ...
        $('#dlImgTop').on('click', function () {
            ...
            const wrapper = document.querySelector('#table_st_digipos_summary .table-responsive');
            ...
            html2canvas(table, {
                ...
                link.download = `table_st_digipos_summary_full_${Date.now()}.png`;
        ...
        $('#dlImgBot').on('click', function () {
            ...
            const wrapper = document.querySelector('#table_st_digipos_detail .table-responsive');
            ...
            html2canvas(table, {
                ...
                const link = document.createElement('a');
                link.href = canvas.toDataURL('image/png');
                link.download = `table_st_digipos_detail_full_${Date.now()}.png`;
                document.body.appendChild(link);
                link.click();
                document.body.removeChild(link);
