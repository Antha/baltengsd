...
<script>
     $(document).ready(function() {
        $('#filter_tap').on('change', function () {
            ...
            $.ajax({
                url: "<?= base_url('/st_nota_vf_byu_dashboard/getPicByTap') ?>",
                type: "POST",
                data: {
                    tap: tap,
        ...
        $('#exportCsvTop').click(function () {
            ...
            const filename = `st_nota_vf_byu_summary_${dateformat}.xlsx`;
        ...
        $('#exportCsvBot').click(function () {
            ...
            // nama file
            const dateformat = new Date().toISOString().replace(/[-:.TZ]/g, '').slice(0,14);
            const filename = `st_nota_vf_byu_detail_${dateformat}.xlsx`;
        ...
        $('#dlImgTop').on('click', function () {
            ...
            const wrapper = document.querySelector('#table_st_nota_vf_summary .table-responsive');
            ...
            html2canvas(table, {
                ...
                link.download = `table_st_vf_byu_summary_full_${Date.now()}.png`;
        ...
        $('#dlImgBot').on('click', function () {
            ...
            const wrapper = document.querySelector('#table_st_nota_vf_detail .table-responsive');
