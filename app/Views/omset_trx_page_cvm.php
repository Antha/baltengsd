                ...
                <div class="col-12 pt-3 pb-2 ps-3 pe-3">
                    <div class="container-fluid rounded main-bg pt-3">
                        <div class="row mt-1">
                            ...
                            <div id="table_ommset_trx_cvm" class="col-12">
                                    ...
                                    <table class="table table-sm table-bordered table-hover table-responsive table-cstm">
                                        <thead>
                                            ...
                                            <tr class="text-center align-middle">
                                                ...
                                                <?php } ?>
                                                <th class="deep_green" scope="col">SUPER SERU</th>
                                                <th class="deep_green" scope="col">HOT PROMO</th>
                                                <th class="deep_green" scope="col">OTHER</th>
                                                <th class="deep_green" scope="col">SS</th>
                                                <th class="deep_green" scope="col">HP</th>
                                                <th class="deep_green" scope="col">OTHER</th>
